...
abstract: |
  ...
  el odds de depresión (IC95 1.90-2.41) vs los que no usan pantalla. La mortalidad completed
  por suicidio adolescente en 15-19 años cambió de régimen en 2010-2018: de 7.5/100k a
  12.0/100k (+60%) [@nchsdb471]. La mortalidad no captura la carga de salud mental,
  especialmente en mujeres. Proponemos un framework operacional *Phone-Free Schools* con
  4 palancas y 5 KPIs SMART, evaluable mediante un RCT cluster-aleatorizado
  (n = 3 000, 2 años, USD 210/est/año).

  **Repositorio y reproducibilidad:** el código completo, los datos limpios y los
  notebooks están disponibles en <https://github.com/dahdor/wired-apart>.
...
include-before-body:
  text: |
    <p align="center"><img src="logo-unimet.png" width="200"/></p>
lang: es
---
